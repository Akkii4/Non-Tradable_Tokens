    ...
    ERC165
{
    ...
    /// @notice Gets all the tokens owned by an address
    /// @param owner Address for whom to get the tokens
    /// @return tokens Array of token identifiers
    function tokensOfOwner(
        address owner
    ) public view virtual returns (uint256[] memory tokens) {
        return _indexedTokenIds[owner];
    }
}
